...
public class Email_reportwithScreenshot  implements IReporter {
	
    private static final Logger L = Logger.getLogger( Email_reportwithScreenshot .class);
    ...
    private void startResultSummaryTable(String style) {
        ...
        out.println("<tr><th>Class</th>"
                + "<th>Method</th><th>Exception & ScreenShots </th><th>Start Time </th><th>Time<br/>(hh:mm:ss)</th></tr>");
        row = 0;
    }
    ...
    protected void endHtml(PrintWriter out) {
        out.println("<center> Report Ended </center>");
